...
class TCBSetupOperation(Operation):
    def __init__(self, tcb: ts_types.Cap, cspace: ts_types.Cap, vspace: ts_types.VSpace, ipc_buffer: ts_types.Cap, ipc_buffer_addr: int, entry_addr: int, stack_top_addr: int):
        self.tcb = tcb
        self.cspace = cspace
        self.vspace = vspace
